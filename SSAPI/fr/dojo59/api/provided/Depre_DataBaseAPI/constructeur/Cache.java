...
class Cache<T extends FieldTable> {
    ...
    protected void forcingUpdateIdentifier() {
        ...
        if (databaseAPI.getSqlFile().getStringList(databaseAPI.getTableName() + ".IdentifierList") != null || !databaseAPI.getSqlFile().getStringList(databaseAPI.getTableName() + ".IdentifierList").isEmpty()) {
            identifierList = databaseAPI.getSqlFile().getStringList(databaseAPI.getTableName() + ".IdentifierList");
        }
